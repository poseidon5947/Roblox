...
function ShopWindow.mount(parent: Instance, onClose: (() -> ())?)
	...
	viewport.Size = UDim2.new(1, -12, 1, -48)
	viewport.Position = UDim2.fromOffset(6, 8)
	...
	for i, item in ipairs(SAMPLE_ITEMS) do
		...
		selectedBadge.Position = UDim2.new(1, -72, 0, 8)
		selectedBadge.Size = UDim2.fromOffset(62, 17)
		...
		selectedBadge.ZIndex = 46
		selectedBadge.Parent = slot
